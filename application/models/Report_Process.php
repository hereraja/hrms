<?php
	...
	class Report_Process extends CI_Model{
		...
		public function f_get_emp_dtls($empno, $sal_month,$sal_yr){
			...
			$result = $this->db->query("select a.trans_date,a.trans_no,a.sal_month,a.sal_year,a.emp_no,a.basic_pay,a.grade_pay,
			...
			,b.emp_name,b.designation,b.phn_no,b.department,b.pan_no,c.name as dept_name
			  from 
			  td_pay_slip a,md_employee b,md_department c 
			  where a.emp_no =b.emp_code
		...
		public function f_get_gov_ben_salary_list($sal,$month){
			...
			ifsc,50100111096908 Debit_Account,'Saving' Beneficiary_Account_type,
