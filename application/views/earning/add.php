          ...
          <div class="card">
                        ...
                        <form method="POST" id="form" action="<?php echo site_url("slryad");?>" >
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <input type="date" name="sal_date" class="form-control required" id="sal_date"
                                     value="<?php echo $sys_date;?>" readonly/>
                                    </div>
                                    <div class="col-6">
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-4">
                        <label for="exampleInputName1">Grade Pay:</label>
                        <input type="text"
                            class= "form-control ded"
                            name = "grade_pay"
                            id   = "grade_pay"
...
<script>
	...
	$(document).ready(function(){
        ...
        $('#grade_pay').change(function(){
            ...
            $('#hra').val(((tot_basic*har_per)/100).toFixed()); 
            $('#da').val((((tot_basic)*da_per)/100).toFixed()); 
