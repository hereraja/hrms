          ...
          <div class="card">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <label for="exampleInputName1">Joining Date:<span class="requiredfield">*</span></label>
                            <input type="date" class="form-control" name="join_dt" id="join_dt"
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-6">
                        ...
                        <input type="date"  class="form-control" name="ret_dt" id="ret_dt"
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-6">
                        ...
                        <input type="text" class= "form-control" name = "phn_no"
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-6">
                        <label for="exampleInputName1">Payslip Generation:<span class="requiredfield">*</span></label><br>
