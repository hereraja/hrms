      ...
      <nav class="navbar top-navbar col-lg-12 col-12 p-0">
        <div class="container">
          <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            <a class="navbar-brand brand-logo topLogo" href="<?=base_url()?>"><img src="<?=base_url()?>assets/images/smb.jpg" alt="logo"/></a>
        ...
        <div class="container">
          <ul class="nav page-navigation">
            ...
            <li class="nav-item">
              ...
              <div class="submenu">
                <ul class="submenu-item">
                  ...
                  <li class="nav-item"><a href="<?php echo site_url("wagemp");?>">Wages Employee</a></li>
                </ul>
              </div>
            </li>
            <?php } ?>
            ...
            <li class="nav-item">
              ...
              <div class="submenu">
                <ul class="submenu-item">
                <?php if($this->session->userdata['loggedin']['user_type']== "A" || $this->session->userdata['loggedin']['user_type']== "U" || $this->session->userdata['loggedin']['user_type']== "M"){  ?> 
                  <li class="nav-item"><a href="<?php echo site_url("leave/applyLeave");?>">Leave Apply</a></li>
                  <?php } ?>
                  <?php if( $this->session->userdata['loggedin']['user_type']== "A"){  ?> 
                  <li class="nav-item"><a href="<?php echo site_url("leave/firstApproval");?>">Leave Approve</a></li>
                  <li class="nav-item"><a href="<?php echo site_url("leave/leaveAllocation");?>">Leave Allocation</a></li>
				 <!-- <li class="nav-item"><a href="<?php //echo site_url("leave/employeeLedger");?>">Employee Ledger</a></li> -->
					
                  <?php } ?>
                  <?php if( $this->session->userdata['loggedin']['user_type']== "M"){  ?>
                    <li class="nav-item"><a href="<?php echo site_url("leave/managerApproval");?>">Manager Approval</a> </li>
                  <?php } ?>  
                  <?php if( $this->session->userdata['loggedin']['user_type']== "U" || $this->session->userdata['loggedin']['user_type']== "M"){  ?> 
                  <li class="nav-item"><a href="<?php echo site_url("leave/personalLedger");?>">Employee Ledger</a> </li>
                  <?php } ?>
                </ul>
              </div>
            </li>
            ...
            <li class="nav-item">
              ...
              <div class="submenu">
                ...
                <?php if( $this->session->userdata['loggedin']['user_type']=="A"){ ?>
                    ...
                    <?php }else if($this->session->userdata['loggedin']['user_type'] == "U" || $this->session->userdata['loggedin']['user_type']== "M") { ?>
					 <li class="nav-item"><a href="<?php echo site_url('reports/indpayslip'); ?>">Payslip</a></li>
                    <li class="nav-item"><a href="<?php echo site_url('reports/pfledger_indivisual'); ?>">Pf Ledger</a></li>
                  <?php } ?>
                </ul>
              </div>
            </li>
