      ...
      <div class="main-panel">
        <div class="content-wrapper"> 
          <div class="card" >
            ...
            <div class="row">
            <div class="col-1 logoPrint"><a href="javascript:void()"><img src="<?=base_url()?>assets/images/smb.jpg" alt="logo" height="50px" width="50px"/></a></div>
            <div class="col-10">
                <div style="text-align:center;" class="printHead">
                <h4><?=ORG_NAME?></h3>
                <h5><?=ORG_ADDRESS?></h4>
                <h5>Pay Slip for <?php echo $months->month_name.'-'.$this->input->post('year');?> </h4>
                  ...
                  <div class="table-responsive table_responsive_print">
                    <table id="order-listing" class="table" width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td>Department</td>
                            <td class="left_algn">:</td>
                            <td class="left_algn"><?php echo $payslip_dtls->dept_name; ?></td>
                            <td></td>
                            <td>Pan No</td>
                            <td class="left_algn">:</td>
                    ...
                    <table class="width tablePrint" cellpadding="6" style="width:100%;" width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tbody> 
                            ...
                            <tr class="t2">
                                ...
                                <td class="left_algn">Basic Salary + Grade Pay</td>
                                <td class="right_algn"><?php echo $payslip_dtls->basic_pay+$payslip_dtls->basic_pay; ?></td>
                            ...
                            <tr class="t2">
                                ...
                                <td class="left_algn">ESI/Medical Insuarance</td>
                            ...
                            <td class="left_algn"></td>
                                <td class="right_algn"></td>
                                <td class="left_algn">Staff Welfare A/C</td>
                                <td class="right_algn"><?php echo $payslip_dtls->comp_loan; ?></td>
                            </tr>
                         ...
                         <tr class="t2"> 
                            ...
                            <tr class="t2">
                                <td class="left_algn"></td>
                                <td class="right_algn"></td>
                                <td class="left_algn">Staff Welfare Advance</td>
                            ...
                            <tr class="t2">
                                <td class="left_algn"></td>
                                <td class="right_algn"></td>
                                <td class="left_algn">Office Advance</td>
                            ...
                            <tr class="t2">
                                ...
                                <td class="right_algn"><b><?php $tot_dd = $payslip_dtls->ptax + 
                                                                ...
                                                                $payslip_dtls->tf+
                                                                $payslip_dtls->telephone; 
                                                                echo number_format(round($tot_dd),2);
                                                                 ?></td></td>
                            ...
                            <tr class="t2">
                                ...
                                <td class="left_algn"></td>
                                <td class="right_algn"></td>
                                <td class="left_algn"><b>Net Amount</b></td>
                                <td class="right_algn"><b><?php echo number_format(round($tot_er - $tot_dd),2); ?></b></td>
                            </tr>
                        </tbody>
                    ...
                    <div>
                       ...
                       <br>
                       <p> ** This is system generated salary slip,signature not required</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                        <form method="POST" id="form" action="<?php echo site_url("reports/indpayslip");?>" >
